export default function Policy() {
  return (
    <div className="container py-2">
      ...
      <p className="text-xl mb-2">Last updated: March 03, 2024</p>
      <p>
      ...
      <ul className="pl-6 my-2">
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Groceyish.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Groceyish, accessible from{" "}
            <a
              href="https://grocery-store-intern-uj7c.vercel.app/"
      ...
      <ul className="pl-6 my-2">
        <li>By email: younesouterbah1@gmail.com</li>
      </ul>
    </div>
  );
}
